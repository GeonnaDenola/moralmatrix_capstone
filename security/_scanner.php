<?php
// security/_scanner.php — scanner + backend validator
...
if (isset($_GET['mode']) && $_GET['mode'] === 'check') {
    ...
    $target = $scheme . '://' . $host . $base . '/security/view_student.php?student_id=' . urlencode($studentId);
...
$finalView = $scheme . '://' . $host . $base . '/security/view_student.php';

// backend validator (this SAME file!)
$qrCheck = $scheme . '://' . $host . $base . '/security/_scanner.php?mode=check';
