...
<nav class="sidebar" aria-label="Main menu" id="sidebarMenu" aria-hidden="false">
 ...
 <a class="nav-item<?php echo activeClass('dashboard.php'); ?>"
    ...
    <a class="nav-item<?php echo activeClass('gmrc_requests.php'); ?>"
       href="<?php echo htmlspecialchars($asset('ccdu/gmrc_requests.php'), ENT_QUOTES); ?>"
       <?php echo $active==='gmrc_requests.php'?'aria-current="page"':''; ?>>
      <span class="nav-ico" aria-hidden="true">
        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16l4-4h10a2 2 0 0 0 2-2V8l-6-6zM13 9V3.5L18.5 9H13z"/></svg>
      </span>
      <span class="nav-label">GMRC Requests</span>
    </a>
    
    <a class="nav-item<?php echo activeClass('gmrc_logs.php'); ?>"
       href="<?php echo htmlspecialchars($asset('ccdu/gmrc_logs.php'), ENT_QUOTES); ?>"
       <?php echo $active==='gmrc_logs.php'?'aria-current="page"':''; ?>>
      <span class="nav-ico" aria-hidden="true">
        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16l4-4h10a2 2 0 0 0 2-2V8l-6-6zM13 9V3.5L18.5 9H13z"/></svg>
      </span>
      <span class="nav-label">GMRC History Logs</span>
    </a>
