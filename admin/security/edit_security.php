...
<main class="content">
  <section id="securityForm" class="form-container" role="region" aria-labelledby="formTitle">
    <div class="form-header">
      <h2 id="formTitle">Edit Security Personnel</h2>
      <a class="back-link" href="../dashboard.php" aria-label="Return to Dashboard">← Back to Dashboard</a>
    </div>

    <form method="POST" action="update_security.php" enctype="multipart/form-data" class="form-grid" novalidate>
      <input type="hidden" name="record_id" value="<?php echo $id; ?>">

      <!-- ID -->
      <div class="field">
        <label for="security_id">ID Number</label>
        <input
          type="text"
          id="security_id"
          name="security_id"
      ...
      <div class="field">
        ...
        <input type="text" id="first_name" name="first_name" value="<?php echo htmlspecialchars($security['first_name']); ?>" required>
      </div>

      <!-- Last Name -->
      <div class="field">
        <label for="last_name">Last Name</label>
        <input type="text" id="last_name" name="last_name" value="<?php echo htmlspecialchars($security['last_name']); ?>" required>
      </div>
      ...
      <div class="field">
        ...
        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($security['email']); ?>" required>
      </div>
      ...
      <div class="actions full">
        <button type="submit" class="btn_submit">Update Security Personnel Information</button>
      </div>
    </form>
  </section>
</main>
